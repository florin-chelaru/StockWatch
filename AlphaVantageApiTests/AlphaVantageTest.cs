...
namespace AlphaVantageApi
{
  ...
  public class AlphaVantageTest
  {
    ...
    public void TimeseriesIntraday_Succeeds()
    {
      ...
      {
        new AlphaVantage.Tick(DateTime.Parse("2018-04-26 16:00:00"), 94.59, 94.26, 94.63, 94.17,
          5988325),
        new AlphaVantage.Tick(DateTime.Parse("2018-04-26 15:59:00"), 94.69, 94.60, 94.71, 94.57,
          305727)
      }.ToImmutableList();
