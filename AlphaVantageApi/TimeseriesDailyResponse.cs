...
namespace AlphaVantageApi
{
  public sealed class TimeseriesDailyResponse
  {
    ...
    public TimeseriesDailyResponse(string symbol, ImmutableDictionary<string, string> metadata, ImmutableList<Tick> timeseries)
    {
      Symbol = symbol;
      Metadata = metadata;
    ...
    public static TimeseriesDailyResponse FromJson(string symbol, string json)
    {
      ...
      return new TimeseriesDailyResponse(symbol, metadata, timeseries.ToImmutable());
    }

    public override bool Equals(object obj)
    {
      return obj is TimeseriesDailyResponse response &&
